...
STRINGS: dict[str, str] = {
    ...
    "partner.requested": "Запрос на партнёрство отправлен {name}. Ждём подтверждения.",
    "partner.request_incoming": "🤝 {name} хочет быть твоим accountability-партнёром.",
    "partner.btn_accept": "✅ Принять",
    "partner.btn_decline": "❌ Отклонить",
    "partner.accepted": "Партнёрство с {name} активно.",
    "partner.accepted_by": "✅ {name} принял твой запрос.",
    "partner.declined": "Партнёрство отклонено.",
    "partner.declined_by": "❌ {name} отклонил твой запрос.",
    "partner.no_pending": "Нет ожидающего запроса от этого пользователя.",
    "admin.menu": "🔧 <b>Админ</b>\nПровайдер: <code>{provider}</code>\nМодель: <code>{model}</code>",
    "admin.btn_test_llm": "🧪 Тест LLM",
